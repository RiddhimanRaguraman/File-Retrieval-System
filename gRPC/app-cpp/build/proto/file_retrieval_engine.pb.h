...
template<> ::fre::RegisterRep* Arena::CreateMaybeMessage<::fre::RegisterRep>(Arena*);
...
class RegisterRep final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fre.RegisterRep) */ {
 public:
  inline RegisterRep() : RegisterRep(nullptr) {}
  ~RegisterRep() override;
  explicit PROTOBUF_CONSTEXPR RegisterRep(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  RegisterRep(const RegisterRep& from);
  RegisterRep(RegisterRep&& from) noexcept
    : RegisterRep() {
    *this = ::std::move(from);
  }
  ...
  friend void swap(RegisterRep& a, RegisterRep& b) {
    a.Swap(&b);
  }
  ...
  RegisterRep* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<RegisterRep>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const RegisterRep& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const RegisterRep& from) {
    RegisterRep::MergeImpl(*this, from);
  }
  private:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fre.RegisterRep";
  }
  protected:
  explicit RegisterRep(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(class_scope:fre.RegisterRep)
 private:
  class _Internal;
...
// int32 client_id = 1;
inline void RegisterRep::clear_client_id() {
  _impl_.client_id_ = 0;
}
inline int32_t RegisterRep::_internal_client_id() const {
  return _impl_.client_id_;
}
inline int32_t RegisterRep::client_id() const {
  // @@protoc_insertion_point(field_get:fre.RegisterRep.client_id)
  return _internal_client_id();
}
inline void RegisterRep::_internal_set_client_id(int32_t value) {
  
  _impl_.client_id_ = value;
}
inline void RegisterRep::set_client_id(int32_t value) {
  _internal_set_client_id(value);
  // @@protoc_insertion_point(field_set:fre.RegisterRep.client_id)
}
...
inline int32_t IndexReq::_internal_client_id() const {
  return _impl_.client_id_;
}
inline int32_t IndexReq::client_id() const {
  // @@protoc_insertion_point(field_get:fre.IndexReq.client_id)
  return _internal_client_id();
}
inline void IndexReq::_internal_set_client_id(int32_t value) {
  
  _impl_.client_id_ = value;
}
inline void IndexReq::set_client_id(int32_t value) {
  _internal_set_client_id(value);
