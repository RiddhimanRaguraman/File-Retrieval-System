...
namespace fre {
PROTOBUF_CONSTEXPR RegisterRep::RegisterRep(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.client_id_)*/0
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct RegisterRepDefaultTypeInternal {
  PROTOBUF_CONSTEXPR RegisterRepDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 RegisterRepDefaultTypeInternal _RegisterRep_default_instance_;
...
static ::_pb::Metadata file_level_metadata_proto_2ffile_5fretrieval_5fengine_2eproto[7];
...
const uint32_t TableStruct_proto_2ffile_5fretrieval_5fengine_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fre::RegisterRep, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::fre::RegisterRep, _impl_.client_id_),
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::fre::RegisterRep)},
  { 7, 15, -1, sizeof(::fre::IndexReq_WordFrequenciesEntry_DoNotUse)},
  { 17, -1, -1, sizeof(::fre::IndexReq)},
  { 26, -1, -1, sizeof(::fre::IndexRep)},
  { 33, -1, -1, sizeof(::fre::SearchReq)},
  { 40, 48, -1, sizeof(::fre::SearchRep_SearchResultsEntry_DoNotUse)},
  { 50, -1, -1, sizeof(::fre::SearchRep)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::fre::_RegisterRep_default_instance_._instance,
...
const char descriptor_table_protodef_proto_2ffile_5fretrieval_5fengine_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "rRep\022\021\n\tclient_id\030\001 \001(\005\"\252\001\n\010IndexReq\022\021\n\t"
  "client_id\030\001 \001(\005\022\025\n\rdocument_path\030\002 \001(\t\022<"
  "\n\020word_frequencies\030\003 \003(\0132\".fre.IndexReq."
  "WordFrequenciesEntry\0326\n\024WordFrequenciesE"
  "ntry\022\013\n\003key\030\001 \001(\t\022\r\n\005value\030\002 \001(\003:\0028\001\"\027\n\010"
  "IndexRep\022\013\n\003ack\030\001 \001(\t\"\032\n\tSearchReq\022\r\n\005te"
  "rms\030\001 \003(\t\"|\n\tSearchRep\0229\n\016search_results"
  "\030\001 \003(\0132!.fre.SearchRep.SearchResultsEntr"
  "y\0324\n\022SearchResultsEntry\022\013\n\003key\030\001 \001(\t\022\r\n\005"
  "value\030\002 \001(\003:\0028\0012\260\001\n\023FileRetrievalEngine\022"
  "6\n\010Register\022\026.google.protobuf.Empty\032\020.fr"
  "e.RegisterRep\"\000\022.\n\014ComputeIndex\022\r.fre.In"
  "dexReq\032\r.fre.IndexRep\"\000\0221\n\rComputeSearch"
  "\022\016.fre.SearchReq\032\016.fre.SearchRep\"\000b\006prot"
  "o3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_proto_2ffile_5fretrieval_5fengine_2eproto = {
    false, false, 642, descriptor_table_protodef_proto_2ffile_5fretrieval_5fengine_2eproto,
    "proto/file_retrieval_engine.proto",
    &descriptor_table_proto_2ffile_5fretrieval_5fengine_2eproto_once, descriptor_table_proto_2ffile_5fretrieval_5fengine_2eproto_deps, 1, 7,
...
RegisterRep::RegisterRep(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:fre.RegisterRep)
}
RegisterRep::RegisterRep(const RegisterRep& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  RegisterRep* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  // @@protoc_insertion_point(copy_constructor:fre.RegisterRep)
}

inline void RegisterRep::SharedCtor(
...
RegisterRep::~RegisterRep() {
  // @@protoc_insertion_point(destructor:fre.RegisterRep)
...
inline void RegisterRep::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void RegisterRep::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void RegisterRep::Clear() {
// @@protoc_insertion_point(message_clear_start:fre.RegisterRep)
...
const char* RegisterRep::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
...
uint8_t* RegisterRep::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:fre.RegisterRep)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fre.RegisterRep)
  return target;
}

size_t RegisterRep::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fre.RegisterRep)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData RegisterRep::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    RegisterRep::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*RegisterRep::GetClassData() const { return &_class_data_; }


void RegisterRep::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<RegisterRep*>(&to_msg);
  auto& from = static_cast<const RegisterRep&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:fre.RegisterRep)
...
// @@protoc_insertion_point(class_specific_copy_from_start:fre.RegisterRep)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool RegisterRep::IsInitialized() const {
  return true;
}

void RegisterRep::InternalSwap(RegisterRep* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_impl_.client_id_, other->_impl_.client_id_);
}

::PROTOBUF_NAMESPACE_ID::Metadata RegisterRep::GetMetadata() const {
...
::PROTOBUF_NAMESPACE_ID::Metadata SearchRep::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_proto_2ffile_5fretrieval_5fengine_2eproto_getter, &descriptor_table_proto_2ffile_5fretrieval_5fengine_2eproto_once,
      file_level_metadata_proto_2ffile_5fretrieval_5fengine_2eproto[6]);
}

// @@protoc_insertion_point(namespace_scope)
}  // namespace fre
PROTOBUF_NAMESPACE_OPEN
template<> PROTOBUF_NOINLINE ::fre::RegisterRep*
Arena::CreateMaybeMessage< ::fre::RegisterRep >(Arena* arena) {
  return Arena::CreateMessageInternal< ::fre::RegisterRep >(arena);
}
